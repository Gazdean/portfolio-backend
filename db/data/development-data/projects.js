module.exports = [
    {
      ...
      image: "./Assets/Images/Project-images/gatherEvents.png",
    ...
    },
    {
      ...
      image: "./Assets/Images/Project-images/squirclesgame.png",
    ...
    },
    {
      ...
      image: "./Assets/Images/Project-images/database.png",
      github: "https://github.com/Gazdean/be-nc1-news1",
      liveProject:"https://newsflash-e6p1.onrender.com/api"
    },
    {
      title: "NC-News Frontend Project",
      description: "A react project, which uses the NC-News backend project as an API to fetch and display news articles, it allows the user to filter news articles by topic, sort by date, comment count or votes and order in ascending or decending order. it allows the user to sign in andto add comments and up vote an article",
      image: "./Assets/Images/Project-images/nc-news-frontend.png",
    ...
    },
    {
      ...
      image: "./Assets/Images/Project-images/flush-finder.png",
      github: "https://github.com/OJ423/flush-finder",
      liveProject:""
    },
